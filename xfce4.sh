...
echo -e "\e[31m\n Mengconfigurasi Kali di dalam Browser, Kau bisa akses https://\$ip:$web_vnc_port\e[0m"
echo -e " Jangan Lupa membuka PORT yang ada TCP $web_vnc_port Jika Kau punya firewall host.".
EOF
